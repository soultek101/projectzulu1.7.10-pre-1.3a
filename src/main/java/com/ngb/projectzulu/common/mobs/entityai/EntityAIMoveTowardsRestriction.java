...
public class EntityAIMoveTowardsRestriction extends EntityAIBase {
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            //this.theEntity.worldObj.getWorldVec3Pool().getVecFromPool((double)chunkcoordinates.posX, (double)chunkcoordinates.posY, (double)chunkcoordinates.posZ));
            		Vec3.createVectorHelper((double)chunkcoordinates.posX, (double)chunkcoordinates.posY, (double)chunkcoordinates.posZ));
            if (vec3 == null)
            {
                return false;
            }
