...
import com.ngb.projectzulu.common.mobs.entity.EntityYellowFinch;
...
public class YellowFinchDeclaration extends SpawnableDeclaration {

    public YellowFinchDeclaration() {
        super("Yellow Finch", 44, EntityYellowFinch.class, EnumCreatureType.ambient);
